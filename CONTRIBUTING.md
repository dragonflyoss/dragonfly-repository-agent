# Contributing to Dragonfly Repository Agent

It is warmly welcomed if you have the interest to hack on dragonfly-repository-agent.
...
If you find a security issue of dragonfly-repository-agent, please do not discuss it in
...
To be honest, we regard every user of dragonfly-repository-agent as a very kind contributor.
After experiencing dragonfly-repository-agent, you may have some feedback for the project.
Then feel free to open an issue via
[NEW ISSUE](https://github.com/dragonflyoss/dragonfly-repository-agent/issues/new).

Since we collaborate project dragonfly-repository-agent in a distributed way,
...
Every action to make project dragonfly-repository-agent better is encouraged.
On GitHub, every improvement for dragonfly-repository-agent could be
...
1. **FORK** dragonfly-repository-agent to your repository.

To make this work, you just need to click the button Fork
in right-left of [dragonflyoss/dragonfly-repository-agent](https://github.com/dragonflyoss/dragonfly-repository-agent)
main page. Then you will end up with your repository in
`https://github.com/<your-username>/dragonfly-repository-agent`,
in which `your-username` is your GitHub username.

1. **CLONE** your own repository to develop locally.

Use `git clone https://github.com/<your-username>/dragonfly-repository-agent.git`
...
1. **Set Remote** upstream to be
   `https://github.com/dragonflyoss/dragonfly-repository-agent.git`

using the following two commands:

```bash
git remote add upstream https://github.com/dragonflyoss/dragonfly-repository-agent.git
...
```bash
$ git remote -v
origin     https://github.com/<your-username>/dragonfly-repository-agent.git (fetch)
origin     https://github.com/<your-username>/dragonfly-repository-agent.git (push)
upstream   https://github.com/dragonflyoss/dragonfly-repository-agent.git (fetch)
...
request is for [branch main](https://github.com/dragonflyoss/dragonfly-repository-agent/tree/main)
in dragonfly-repository-agent. Before contributing,
...
While in project dragonfly-repository-agent, there are several other branches,
...
Actually in dragonfly-repository-agent, we take two rules seriously when committing:
...
PR is the only way to make change to dragonfly-repository-agent project files.
...
We choose GitHub as the primary place for dragonfly-repository-agent to
collaborate. So the latest updates of dragonfly-repository-agent are always here.
...
- Discuss about dragonfly-repository-agent to make things clearer.
- Advocate dragonfly-repository-agent technology beyond GitHub.
- Write blogs on dragonfly-repository-agent and so on.
...
- Submit a PR in the
  [dragonflyoss/dragonfly-repository-agent](https://github.com/dragonflyoss/dragonfly-repository-agent) repo.
